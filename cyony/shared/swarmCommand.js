...
import { createReasonLoop, createRunManager, createEventStream, createApprovalGate, } from "@tripp-reason/core";
import { initDb, createRepositories } from "@tripp-reason/store";
import { OpenAICompatibleProvider } from "@tripp-reason/providers";
import { createDispatcher, listDirTool, readFileTool, searchTool, gitStatusTool, gitDiffTool, writeFileTool, editFileTool, shellTool, runTestsTool, } from "@tripp-reason/tools";
...
import { printSwarmHeader, printSwarmResult, printSwarmError, printApprovalDenied, printWorkerCapRejected, } from "./swarmOutput.js";
import { printEvent } from "./output.js";
export async function executeSwarm(prompt, options) {
    // Resolve mode
...
// ── Startup Approval ──────────────────────────────────────────────
async function promptStartupApproval(mode, maxWorkers) {
...
// ── Swarm Report Writer ───────────────────────────────────────────
async function writeSwarmReport(summary, workdir) {
...
//# sourceMappingURL=swarmCommand.js.map