...
export function reportsRoute(app, workdir) {
...
function classifyReport(filename) {
    ...
    if (lower.includes("phase") || lower.includes("step_0"))
        return "phase";
    if (lower.includes("swarm") || lower.startsWith("plan_"))
        return "swarm";
    if (lower.startsWith("run-") || lower.includes("_run_"))
        return "run";
    return "unknown";
}
