export function printSwarmHeader(mode, workerCount) {
    console.log("\n" + "═".repeat(60));
    console.log(`🐝 Swarm: ${mode} mode — ${workerCount} workers`);
    console.log("═".repeat(60));
}
export function printSwarmResult(summary) {
    console.log("\n" + "─".repeat(60));
    ...
    if (allTools.size > 0) {
        console.log("\n🔧 Tool Calls:");
        for (const t of Array.from(allTools))
            console.log(`  • ${t}`);
    }
    // Conflicts
