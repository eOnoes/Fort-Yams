...
import { ensureAgentBus, getAgentBusPaths, writeTaskPacket, writeResultPacket, readTaskPacket, readResultPacket, listInboxPackets, listOutboxPackets, movePacketToArchive, movePacketToRejected, createTaskPacketFilename, createResultPacketFilename, } from "../fileBus.js";
// ── Helpers ───────────────────────────────────────────────────────────
let tmpDir;
...
describe("path safety", () => {
    it("rejects path traversal writes", async () => {
        ...
        await expect(writeTaskPacket(packet, { workdir: tmpDir, filename: `../../escape.json` })).rejects.toThrow();
    });
});
// ── List Tests ────────────────────────────────────────────────────────
...
//# sourceMappingURL=fileBus.test.js.map